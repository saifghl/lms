...
import "../admin/Sidebar.css"; // Reuse the premium admin sidebar styles
  ...
  return (
    <div className="sidebar">
      ...
      <div className="sidebar-nav">
        ...
        <div
          className={`nav-item ${isActive('doc-repo') ? 'active' : ''}`}
        ...
        <div
          className={`nav-item ${isActive('review-center') ? 'active' : ''}`}
          onClick={() => navigate('/management/review-center')}
        >
          <span className="icon">
        ...
        <div
          ...
          onClick={() => navigate('/management/lease-tracker')}
        >
          <span className="icon">
